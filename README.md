...
- [x] Reconcile any differences between current versions of settings.py and what's in RCS
  ...
  - [x] Groja.com
  - [x] Seeourminds.com
- [x] Ensure 404 - Page Not Found functionality works on all sites
  - [x] Artsyvisions.com
  - [x] Groja.com
  - [x] Seeourminds.com
- [x] SeeOurMinds.com - add affiliate marketing links - Phase I
...
The to do list is now in:

- `todo/todo.md` in the `jmws_accoutrements` repo
